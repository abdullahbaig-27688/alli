...
with_node \
  ...
  --target "/Volumes/Muhammad Abdullah Baig/alli/ios/Pods/Target Support Files/Pods-AlliNutritionApp/ExpoModulesProvider.swift" \
  --entitlement "/Volumes/Muhammad Abdullah Baig/alli/ios/AlliNutritionApp/AlliNutritionApp.entitlements" \
   \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-av" "expo-camera" "expo-clipboard" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-image-picker" "expo-keep-awake" "expo-linear-gradient" "expo-linking" "expo-media-library" "expo-router" "expo-speech"
